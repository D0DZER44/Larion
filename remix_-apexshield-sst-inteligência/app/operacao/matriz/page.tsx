...
import { NR_MATRIX, NR_MATRIX_ORDENADA, getNRsAplicaveis, compareNRs } from '@/lib/nrMatrix';
            ...
            {activeTab === 'Matriz' ? (
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="grid gap-4">
                      {NR_MATRIX_ORDENADA.filter(nr => selectedSegment === 'Todos' || nr.segmentosAplicaveis.includes('Todos') || nr.segmentosAplicaveis.includes(selectedSegment)).map((nr) => {
              ...
              <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="space-y-8">
                   {[...fixedNrChecklists].sort((a: any, b: any) => {
                      const numA = parseInt(((a.id || a.titulo || '').toString().match(/(\d+)/) || [])[1] || '9999', 10);
                      const numB = parseInt(((b.id || b.titulo || '').toString().match(/(\d+)/) || [])[1] || '9999', 10);
                      if (numA !== numB) return numA - numB;
                      return ((a.titulo || a.name || '') as string).localeCompare(((b.titulo || b.name || '') as string), 'pt-BR', { sensitivity: 'base' });
                   }).map((chk: any) => (
