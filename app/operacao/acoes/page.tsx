...
import EmAndamento from '../../acoes/components/EmAndamento';
import Concluidas from '../../acoes/components/Concluidas';
import Historico from '../../acoes/components/Historico';
import DrawerAcao from '../../acoes/components/DrawerAcao';
import { ActionItem } from '../../acoes/types';
import ModalNovaAcao from '../../acoes/components/ModalNovaAcao';
          ...
          <header className="flex items-center justify-between gap-4 mb-6 shrink-0">
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-gray-400 mb-2">
                 ...
                 <span>&gt;</span>
                 <span className="text-purple-400">{activeTab === 'VisaoGeral' ? 'Visão Geral' : activeTab === 'EmAndamento' ? 'Em andamento' : activeTab === 'Concluidas' ? 'Concluídas' : activeTab === 'Historico' ? 'Histórico' : activeTab}</span>
              </div>
