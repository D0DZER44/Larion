      ...
      <main className="mx-auto flex w-full max-w-[1600px] flex-col p-4 md:p-6 lg:p-8">
        <header className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="mb-1 text-[11px] font-bold uppercase tracking-[0.32em] text-purple-300/80">Central de inteligencia</p>
              ...
              {model.topCards.map((card: any) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative overflow-hidden rounded-[22px] border bg-[#0b0f19]/80 p-5 text-left shadow-xl shadow-black/20 backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:border-white/20 ${tone.border}`}
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mt-3 text-4xl font-black tracking-tight text-white">{card.value}</div>
                ...
                {model.timeline.length === 0 ? (
                  <div className="mt-6 rounded-[24px] border border-dashed border-white/10 bg-white/[0.02] p-8 text-center">
                    ...
                    <p className="mt-2 text-sm leading-6 text-gray-500">
                      Assim que inspeções, riscos e acoes gerarem logs operacionais, a linha do tempo passa a explicar o impacto no score.
                    </p>
                  </div>
                ) : (
                  <div className="mt-6 space-y-4">
